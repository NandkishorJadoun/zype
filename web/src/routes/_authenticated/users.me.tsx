  ...
  return (
    <div className="flex-1 flex flex-col bg-surface-primary rounded-xl overflow-hidden">
      <header className="bg-surface-elevated/80 glass border-b border-separator h-[52px] flex items-center justify-center px-4 flex-shrink-0 relative rounded-t-xl">
        ...
        <Link
          to="/users/me/edit"
          className="absolute right-3 inline-flex items-center justify-center size-[32px] rounded-full text-text-secondary hover:bg-surface-secondary hover:text-text-primary transition-all duration-150"
          aria-label="Edit profile"
        >
          <HugeiconsIcon icon={Edit03Icon} size={18} strokeWidth={2} />
        </Link>
      </header>
